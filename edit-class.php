...
$sql="update  tblclasses set ClassName=:classname,ClassNameNumeric=:classnamenumeric,Semester=:Semester where id=:cid ";
...
{   ?>
                                                    ...
                                                    <div class="form-group has-success">
                                                		...
                                                		<div class="">
                                                            ...
                                                            <span class="help-block">Eg- Computer, Electrical, Mechanical etc</span>
                                                		</div>
                                                	</div>
                                                       <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                            ...
                                                            <span class="help-block">Eg- 101,201,1001,2001 etc</span>
                                                        </div>
                                                    </div>
                                                     <div class="form-group has-success">
                                                        <label for="success" class="control-label">Semester</label>
                                                        <div class="">
                                                            <input type="text" name="Semester" value="<?php echo htmlentities($result->Semester);?>" class="form-control" required="required" id="success">
