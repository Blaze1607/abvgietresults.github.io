...
<html lang="en">
    <head>
        ...
        <title>ABVGIET Result Management System</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-12">
                                    <h2 class="title" align="center">ABVGIET Result Management System</h2>
                                </div>
                            </div>
...
$qery = "SELECT   tblstudents.StudentName,tblstudents.RollId,tblstudents.RegDate,tblstudents.StudentId,tblstudents.Status,tblclasses.ClassName,tblclasses.Semester from tblstudents join tblclasses on tblclasses.id=tblstudents.ClassId where tblstudents.RollId=:rollid and tblstudents.ClassId=:classid ";
...
<p><b>Student Board Id :</b> <?php echo htmlentities($row->RollId);?>
<p><b>Student Class:</b> <?php echo htmlentities($row->ClassName);?>(<?php echo htmlentities($row->Semester);?>)
<?php }
...
<tr>
<th scope="row" colspan="2" style="text-align: center">Total Percentage</th>           
