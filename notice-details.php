...
<html lang="en">
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container">
			<a href="http://www.abvgiet.org"><img src="images/Logo123.png"></a>
...
<?php }} ?>
        ...
        <footer class="py-5 bg-dark">
            <div class="container"><p class="m-0 text-center text-white">Copyright &copy; Atal Bihari Vajpayee Government Institute of Engineering & Technology 2011 <?php echo date('Y');?></p></div>
        </footer>
